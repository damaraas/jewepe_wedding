        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="<?= base_url('assets/landing/') ?>img/beranda-1.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    <p class="fs-4 text-white animated zoomIn">Selamat Datang di <strong class="text-dark">JeWePe Wedding Origanizer</strong></p>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="<?= base_url('assets/landing/') ?>img/beranda-2.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="section-title text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 800px;">
                ...
                <h1 class="display-6">Silahkan pilih paket yang Anda sukai</h1>
            </div>
            <div class="row g-4">
                <?php
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="store-item position-relative text-center">
                        <img class="img-fluid" src="<?= base_url('assets/files/katalog/') . $row->gambar ?>" alt="">
                        <div class="p-4">
                            <h4 class="mb-3"><?= $row->judul_katalog; ?></h4>
                            <?= word_limiter(strip_tags($row->isi_katalog), 20); ?>
