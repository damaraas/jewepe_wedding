...
<head>
    ...
    <!-- Favicon -->
    <link href="<?= base_url('assets/landing/') ?>img/logo-1.png" rel="icon">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0">
                <a href="index.html" class="navbar-brand">
                    <img class="img-fluid" src="<?= base_url('assets/landing/') ?>img/logo-1.png" alt="Logo">
                </a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt text-primary me-3"></i><?= $getDataWeb->nomor_telepon; ?></p>
                    ...
                    <div class="d-flex pt-3">
                        ...
                        <a class="btn btn-square btn-primary rounded-circle me-2" href="https://www.linkedin.com/in/damara-salsabila14/"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <h6 class="text-light"><?= $getDataWeb->time_business_hour; ?></h6>
