                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 text-right">
                            <a href="<?= base_url('admin/Katalog/add'); ?>" class="btn btn-primary">Tambah Katalog</a>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-sm btn-danger" href="<?= base_url('admin/Katalog/delete?id=') . $row->id_katalog ?>" title="Delete" onclick="if (! confirm('Apakah Anda yakin akan menghapus Katalog ini??')) { return false; }">Delete</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
