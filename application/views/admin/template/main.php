...
<head>
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="<?= base_url('assets/landing/') ?>img/logo-1.png" />
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="index.html"><img src="<?= base_url('assets/landing/') ?>img/logo-1.png" class="mr-2" alt="logo" /></a>
            </div>
